...
const users = [
  ...
  const usersWithBlueColor = users.filter(user => user.color.includes("blue"));

   

  const userNamesWithBlueColor = usersWithBlueColor.map(user => user.name);
  
  console.log(userNamesWithBlueColor);